About tfcausalimpact-feedstock
==============================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/tfcausalimpact-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/tfcausalimpact-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add tfcausalimpact
# for installing globally
pixi global install tfcausalimpact
```
...
It is possible to list all of the versions of `tfcausalimpact` available on your platform:
...
```
pixi search tfcausalimpact --channel conda-forge
```
